...
function calcularmedia(nota1, nota2, nota3, codigoAluno){
    ...
    return `Código do aluno: ${codigoAluno}; Notas: ${notas[0]}, ${notas[1]},  ${notas[2]}; Média: ${mediafinal}; Situação: ${mediafinal < 5 ? 'Reprovado' : 'Aprovado'}`
}

console.log(calcularmedia(3, 9.5, 0, 100))
